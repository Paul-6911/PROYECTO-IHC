      ...
      <div class="item active" style="background-image:url(images/slide/carrusel1.jpg)">
            <div class="slider-content text-left">
               <div class="col-md-12">
                   ...
                   <p class="effect3">
                    <a href="form-aseguramiento.html" class="slider btn btn-primary">Asegurarme</a>
                    <a href="aboutus.html" class="slider btn btn-secondary">Sobre Nosotros</a>
                   </p>      
               </div>
            </div>
            ...
            <div class="slider-content">
               <div class="col-md-12 text-center">
                   ...
                   <p>
                    ...
                    <a href="portfolio-4.html" class="slider btn btn-secondary">Doctores</a>
                   </p>      
               </div>
            </div>
       ...
       <div class="item" style="background-image:url(images/slide/carrusel3.jpg)">
            <div class="slider-content text-right">
               <div class="col-md-12">
                   ...
                   <p>
                    <a href="formCita.html" class="slider btn btn-primary">Programar cita</a>
                    <a href="contact.html" class="slider btn btn-secondary">Contáctenos</a>
    ...
    <div class="row">
       <div class="col-md-8 nopadding">
            ...
            <div class="section-2-box-left wow bounceIn"><!---bounceIn / fadeInLeft / fadeInRight  
              ...
              <a href="masInfoIndependencia.html" class="btn btn-primary">Más información</a>
            </div>-->
          ...
          <div class="col-md-6 col-sm-6">
            <div class="section-2-box-left wow bounceIn">
              ...
              <a href="masInfoSanBorja.html" class="btn btn-primary">Más información</a>
            </div>
          </div>
          --->
